# Generated by Django 5.0.7 on 2024-08-04 12:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, null=True, unique=True)),
                ('reels', models.FileField(blank=True, null=True, upload_to='reels/')),
                ...
                ('profile_images', models.ManyToManyField(blank=True, to='accounts.userprofileimage')),
            ],
            options={
                'verbose_name': 'user',
